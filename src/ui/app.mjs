...
document.addEventListener("submit", async (event) => {
  ...
  try {
    if (form.id === "discovery-link-form") {
      ...
      await setSettings({transfer:{speedKiB:Number(values.speedKiB),scheduled:form.elements.scheduled.checked,start:values.start,end:values.end}});toast("Download preferences saved.");
