...
export function HelpPage({ onAction }: { onAction: (command: HelpCommand) => Promise<void> }) {
  return <main><section className="simple-heading"><div className="eyebrow">HOW IT WORKS</div><h1>From channel to collection.</h1><p>Your next season, a few simple steps away.</p></section>
    <section className="help-guide workspace-scroll" tabIndex={0} role="region" aria-label="How it works">
      <div className="help-hero"><div className="help-hero-copy"><span className="help-kicker"><Icon name="shelf" /> A HOME FOR EVERY EPISODE</span><h2>Less sorting.<br />More watching.</h2><p>Find a series, choose your files and let Season Shelf organise the download.</p>
      ...
      <div className="help-section-heading"><div><span className="help-kicker">GOOD TO KNOW</span><h2>A little more detail, when you need it.</h2></div></div>
